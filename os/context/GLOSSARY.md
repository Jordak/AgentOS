...
- Drift: a mismatch between the current intended AgentOS state and installed local adapters, automations, or other current-machine setup.
...
- Skill adapter: a current-machine link or thin wrapper that lets a harness discover or invoke a canonical AgentOS skill directly.
