...
13. Confirm PR-bound work has visible PR-body readiness fields, and that intentional bypasses name the durable `Gate skipped:` field or the exact proposed update when writes were unavailable.
