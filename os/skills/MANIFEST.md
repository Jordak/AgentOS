...
- Output artifact: a pull request with readiness fields, review-loop convergence evidence, and a recoverable Workflow Result naming issue, branch/worktree, PR, readiness verdict, validation, mutations, review-loop status, open risks, and recommended next action for the integration owner.
