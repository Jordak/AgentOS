...
- Verification coverage: confirm target/base/head and review-pass sizing, durable design readiness or recorded gate skip for feature-sized targets, baseline intent, review-pass template usage, structural-depth lens instructions when assigned, accepted/declined findings, sibling sweeps, validation commands, consolidated Agent Review comment shape when posted, clean final fresh review-pass packet, temporary HTML report, and absence of unapproved external writes.
