...
- `os/verification/BENCHMARK_STATUS.md`: current public-safe Core benchmark snapshot. The local index and harness grader exclude this file so previous summaries cannot contaminate answer-key discovery.
